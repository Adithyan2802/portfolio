...
const ProjectCard = ({ index, name, subtitle, description, image, href }) => {
  return (
          ...
          <div className="relative items-center flex flex-col justify-center">
            <div className="absolute -top-6 flex justify-end m-3 w-full gap-1">
              ...
              {index === 1 && (
                <div
                  onClick={() =>
                    window.open("https://homemod.com.au", "_blank")
                  }
                  className="bg-black w-10 h-10 rounded-full flex justify-center items-center cursor-pointer hover:opacity-80"
                >
                  <img
              ...
              {index === 2 && (
                <div
                  onClick={() =>
                    window.open("https://sage-wallet.vercel.app", "_blank")
                  }
                  className="bg-black w-10 h-10 rounded-full flex justify-center items-center cursor-pointer hover:opacity-80"
                >
                  <img
...
const Projects = () => {
  return (
    <section className="relative max-w-7xl mx-auto c-space" id="projects">
      ...
      <DotPattern className="-z-10 [mask-image:radial-gradient(700px_circle_at_center,white,transparent)]" />
    </section>
  );
};
